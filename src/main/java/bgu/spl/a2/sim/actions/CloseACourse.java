...
public class CloseACourse extends Action<Boolean>{
	 ...
	 * students. The number of available spaces of the closed course should be updated to -1. is NOT
	 * removing its actor. After closing the course, all the request for registration should be denied.
